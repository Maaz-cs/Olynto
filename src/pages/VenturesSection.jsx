<style>{`
  ...
  .ventures-modern {
    ...
    --vm-panel: #101111;
    --vm-white: #f5f5f2;
    --vm-muted: rgba(245,245,242,.62);
    --vm-soft: rgba(245,245,242,.36);
    --vm-line: rgba(255,255,255,.11);
    --vm-gold: #c8a45c;
    --vm-gold-light: #e1c889;
  ...
  .vm-explore:hover .vm-explore-icon {
    background: var(--vm-gold);
    color: #080808;
  }
  ...
  @media (max-width: 450px) {
    ...
    .vm-card {
      width: var(--vm-card-width);
      height: var(--vm-card-height);
    }
